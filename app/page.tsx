  ...
  return (
    <div className="flex flex-grow items-center justify-between">
      <div className='w-1/2 h-full flex justify-center items-center flex-col'>
        <div className={`font-bold ${dmSerifDisplay.className} text-[48px] bg-white p-10 text-[#2da74b] `}>Welcome to Home of
          <br /> Priyankara Tea Buyers</div>
        <div className={`${dmSerifDisplay.className} text-[32px] text-[#296b6e]`}>-Steeped in Downsouth Elegance-</div>
